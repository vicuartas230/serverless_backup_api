...
class ServerlessBackupApiStack extends cdk.Stack {
  constructor(scope, id, props) {
    ...
    table.grantReadWriteData(getFullData);
    table.grantReadWriteData(createContact);
    table.grantReadWriteData(updateContact);
    table.grantReadWriteData(deleteContact);

    const api = new apigateway.RestApi(this, 'backupApi', {
      restApiName: 'Backup API',
      defaultCorsPreflightOptions: {
        allowOrigins: ['https://main.d22jsmcuko49pi.amplifyapp.com'],
